package br.net.dd.netherwingcore.game.accounts;
...
public class RBAC {
    ...
    public static class RBACPermission {

        private final int id;
        private final String name;
        private Set<Integer> perms = new TreeSet<>();
        ...
        public Set<Integer> getLinkedPermissions() {
            return perms;
        }

        public void addLinkedPermission(int permission) {
            perms.add(permission);
        }

        public void removeLinkedPermission(int permission) {
    ...
    public static class RBACData{
        ...
        private Set<Integer> grantedPerms = new TreeSet<>();
        private Set<Integer> deniedPerms = new TreeSet<>();
        private Set<Integer> globalPerms = new TreeSet<>();

        public RBACData(int id, String name, int realmId, int secLevel) {
            this.id = id;
            this.name = name;
        ...
        public boolean hasPermission(int permission) {
            return globalPerms.contains(permission);
        }
        ...
        public Set<Integer> getGrantedPermission () {
            return grantedPerms;
        }

        public Set<Integer> getDeniedPermission () {
            return deniedPerms;
        }

        public RBACCommandResult grantPermission(int permissionId, int realmId) {
            return RBACCommandResult.RBAC_ID_DOES_NOT_EXISTS; // TODO: implement
        }

        public RBACCommandResult denyPermission(int permissionId, int realmId) {
            return RBACCommandResult.RBAC_ID_DOES_NOT_EXISTS; // TODO: implement
        }

        public RBACCommandResult revokePermission(int permissionId, int realmId) {
            return RBACCommandResult.RBAC_ID_DOES_NOT_EXISTS; // TODO: implement
        }
        ...
        public void loadFromCallback() {}

        public void setSecurityLevel(int id) {
            this.secLevel = id;
            loadFromDB();
        }
    ...
    public static enum RBACPermissions {
        ...
        RBAC_PERM_MAX                                            (RBACPermissions.values().length);
    ...
    public static enum RBACCommandResult {
        RBAC_OK,
